...
export class ProductCategoryService {
  ...
  public static onFullNameSearch() {
    Axios.post(Axios.defaults.baseURL + 'panel/employee/search/employee-search?full_name', ProductCategoryService.full_name_search,
      {
        headers: {
      ...
      .then(res => {
        ProductCategoryService.employees = res.data.data;
      })
  }

  public static onUserNameSearch() {
    Axios.post(Axios.defaults.baseURL + 'panel/employee/search/employee-search?username', ProductCategoryService.username_search,
      {
        headers: {
          'Authorization': 'Bearer ' + ProductCategoryService.token
        }
      }).then(res => {
      ProductCategoryService.employees = res.data.data;
    })
  ...
  public static onEmailSearch() {
    Axios.post(Axios.defaults.baseURL + 'panel/employee/search/employee-search?email', ProductCategoryService.email_search,
      {
        headers: {
          'Authorization': 'Bearer ' + ProductCategoryService.token
        }
